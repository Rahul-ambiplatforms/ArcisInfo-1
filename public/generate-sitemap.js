...
async function generate() {
  ...
  const staticRoutes = [
    ...
    { loc: buildUrlLoc("/solution/edge-ai"), changefreq: "weekly", priority: "0.8" },
    { loc: buildUrlLoc("/solution/corporate"), changefreq: "weekly", priority: "0.8" },
    { loc: buildUrlLoc("/solution/retail"), changefreq: "weekly", priority: "0.8" },
    { loc: buildUrlLoc("/solution/banking"), changefreq: "weekly", priority: "0.8" },
    { loc: buildUrlLoc("/solution/smart-city"), changefreq: "weekly", priority: "0.8" },
    { loc: buildUrlLoc("/solution/healthcare"), changefreq: "weekly", priority: "0.8" },
    { loc: buildUrlLoc("/solution/manufacturing"), changefreq: "weekly", priority: "0.8" },
    { loc: buildUrlLoc("/solution/logistics"), changefreq: "weekly", priority: "0.8" },
    ...
    { loc: buildUrlLoc("/events/convergence-india-2026"), changefreq: "monthly", priority: "0.8" },
    ...
    { loc: buildUrlLoc("/ai-cctv-cameras-new-york"), changefreq: "monthly", priority: "0.8" },
    { loc: buildUrlLoc("/ai-cctv-cameras-washington-dc"), changefreq: "monthly", priority: "0.8" },
    { loc: buildUrlLoc("/ai-cctv-cameras-houston"), changefreq: "monthly", priority: "0.8" },
