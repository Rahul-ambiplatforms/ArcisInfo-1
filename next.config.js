...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      // Numeric-URL fix (2026-09-21): /0-/9 used to be the only live routes
      // for these 10 compliance pages (an array-spread bug in
      // resolveSeoPageData.js assigned array indices as keys instead of each
      // entry's own slug -- fixed there). Redirecting the old numeric paths
      // preserves any existing search-index signal or backlinks while the
      // real, descriptive slugs take over as canonical.
      {
        source: "/0",
        destination: "/ndaa-compliant-ai-security-cameras",
        permanent: true,
        statusCode: 301,
      },
      {
        source: "/1",
        destination: "/saudi-arabia-pdpl-compliant-cctv-cameras",
        permanent: true,
        statusCode: 301,
      },
      {
        source: "/2",
        destination: "/uae-data-protection-compliant-security-cameras",
        permanent: true,
        statusCode: 301,
      },
      {
        source: "/3",
        destination: "/gdpr-compliant-cctv-camera-systems",
        permanent: true,
        statusCode: 301,
      },
      {
        source: "/4",
        destination: "/eu-ai-act-compliant-ai-cameras",
        permanent: true,
        statusCode: 301,
      },
      {
        source: "/5",
        destination: "/non-chinese-security-camera-alternatives",
        permanent: true,
        statusCode: 301,
      },
      {
        source: "/6",
        destination: "/gcc-government-approved-security-cameras",
        permanent: true,
        statusCode: 301,
      },
      {
        source: "/7",
        destination: "/taa-compliant-security-cameras",
        permanent: true,
        statusCode: 301,
      },
      {
        source: "/8",
        destination: "/india-bis-certified-cctv-cameras",
        permanent: true,
        statusCode: 301,
      },
      {
        source: "/9",
        destination: "/critical-infrastructure-security-cameras",
        permanent: true,
        statusCode: 301,
      },
    ];
