    ...
    <Box mt="6%" p="2%" maxW={"1440px"} mx={"auto"} overflow={"hidden"} textAlign={"justify"} color="white">
      ...
      <Box mb={6}>
        ...
        <Text mb={0}>
          ...
          This document explains how the agreement is made up and sets out some
      ...
      <Box mb={6}>
        ...
        <List spacing={2} mb={0}>
          <ListItem>
            ...
            available to you by ArcisAI in the user interface for any Service;
          </ListItem>
          <ListItem>
            <Text as="span" fontWeight="bold">
              B)
            ...
            agree that ArcisAI will treat your use of the Services as acceptance
      ...
      <Box mb={6}>
        ...
        <Text mb={0}>
          ArcisAI is constantly innovating in order to provide the best possible
          experience for its users. You acknowledge and agree that the form and
          nature of the Services which ArcisAI provides may change from time to
          time without prior notice to you.
        </Text>
        <Text mb={0}>
          As part of this continuing innovation, you acknowledge and agree that
          ArcisAI may stop (permanently or temporarily) providing the Services
          (or any features within the Services) to you or to users generally at
          ArcisAI's sole discretion, without prior notice to you. You may stop
          using the Services at any time. You do not need to specifically inform
          ArcisAI when you stop using the Services.
        </Text>
      </Box>
      <Box mb={6}>
        <Heading as="h4" size="md" mb={0}>
        ...
        <Text mb={0}>
          You agree that you are solely responsible for (and that ArcisAI has no
          ...
          loss or damage which ArcisAI may suffer) of any such breach.
        </Text>
        <Text mb={0}>
        ...
        <Text>
          ...
          communications from ArcisAI, which is important for ArcisAI to deliver
          the Services to you.
        </Text>
      </Box>
      <Box mb={6}>
        ...
        <Text mb={0}>
          For information about ArcisAI's data protection practices, please read
          ArcisAI's privacy policy.
        </Text>
        <Text>
          You agree to the use of your data in accordance with ArcisAI's privacy
          policies.
        </Text>
      </Box>
      <Box mb={6}>
        ...
        <Text mb={0}>
          ...
          complete discretion whether to publish your Content and have the right
          to delete any and all Content at any time which we believe to be in
          violation of the "Prohibited Content".
        </Text>
        <Text mb={0}>
          ...
          that you may do so by ArcisAI or by the owners of that Content, in a
          separate agreement.
        </Text>
        <Text mb={0}>
      ...
      <Box mb={6}>
        ...
        <Text mb={0}>
          ...
          resources. ArcisAI may have no control over any web sites or resources
          which are provided by companies or persons other than ArcisAI.
        </Text>
        <Text mb={0}>
      ...
      <Box mb={6}>
        ...
        <Text mb={0}>
          You acknowledge and agree that ArcisAI owns all legal right, title and
        ...
        <Text mb={0}>
          ...
          features in a separate written agreement with ArcisAI, then you agree
          that your use of such features shall be in compliance with that
          agreement, any applicable provisions of the Terms, and ArcisAI's brand
        ...
        <Text mb={0}>
          ...
          otherwise in writing with ArcisAI, you agree that you are responsible
          for protecting and enforcing those rights and that ArcisAI has no
        ...
        <Text mb={0}>
          ...
          ArcisAI Ai, you agree that in using the Services, you will not use any
      ...
      <Box mb={6}>
        ...
        <Text mb={0}>
          ArcisAI gives you a personal, worldwide, royalty-free, non-assignable
          and non-exclusive license to use the software provided to you by
          ArcisAI Ai as part of the Services (referred to as the "Software"
          below). This license is for the sole purpose of enabling you to use
          and enjoy the benefit of the Services as provided by ArcisAI, in the
        ...
        <Text mb={0}>
          ...
          may do so by ArcisAI, in writing.
        </Text>
        <Text mb={0}>
          Subject to section 1.2, unless ArcisAI has given you specific written
      ...
      <Box mb={6}>
        ...
        <Text mb={0}>
          ...
          updates from time to time from ArcisAI. These updates are designed to
          ...
          ArcisAI to deliver these to you) as part of your use of the Services.
        </Text>
      </Box>
      <Box mb={6}>
        <Heading as="h4" size="md" mb={0}>
        ...
        <Text mb={0}>
          ArcisAI may at any time, terminate its legal agreement with you if (A)
          ...
          with the provisions of the Terms); or (B) ArcisAI is required to do so
          by law (for example, where the provision of the Services to you is, or
          becomes, unlawful); or (C) the partner with whom ArcisAI offered the
          Services to you has terminated its relationship with ArcisAI or ceased
          to offer the Services to you; or (D) ArcisAI is transitioning to no
          longer providing the Services to users in the country in which you are
          resident or from which you use the service; or (E) the provision of
          the Services to you by ArcisAI is, in ArcisAI's opinion, no longer
          commercially viable.
        </Text>
        <Text mb={0}>
        ...
        <Text>
          ...
          and liabilities that you and ArcisAI have benefited from, been subject
      ...
      <Box mb={6}>
        ...
        <Text mb={0}>
          ...
          limit ArcisAI's warranty or liability for losses which may not be
        ...
        <Text mb={0}>
          ...
          from ArcisAI or through or from the services shall create any warranty
      ...
      <Box mb={6}>
        ...
        <Text mb={0}>
          ...
          any changes which ArcisAI may make to the services, or for any
          ...
          your failure to provide ArcisAI with accurate account information; (v)
          your failure to keep your password or account details secure and
          confidential;
        </Text>
        <Text mb={0}>
          The limitations on ArcisAI's liability to you in paragraph 14.1 above
          shall apply whether or not ArcisAI has been advised of or should have
      ...
      <Box mb={6}>
        ...
        <Text mb={0}>
          The manner, mode, and extent of advertising by ArcisAI on the Services
      ...
      <Box mb={6}>
        ...
        <Text mb={0}>
          ...
          and hold ArcisAI, its subsidiaries, affiliates, officers, employees,
      ...
      <Box mb={6}>
        ...
        <Text mb={0}>
          <strong>Exceptions</strong> - You and ArcisAI agree that the following
          ...
          or concerning the validity of, any of your or ArcisAI intellectual
          ...
          In addition to the foregoing, either you or ArcisAI may assert an
      ...
      <Box mb={6}>
        ...
        <Text>
          ArcisAI will be excused from performance under this Agreement for any
          period of time that ArcisAI is prevented from performing its
