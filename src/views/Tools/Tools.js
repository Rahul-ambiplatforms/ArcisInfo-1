  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (!cancelled) setError('Failed to load tools data. Please try again later.');
      } finally {
      ...
      <Container maxW="1200px" px={{ base: 4, md: 8 }}>
        <VStack spacing={4} mb={{ base: 8, md: 12 }} textAlign="center" align="center">
          ...
          <Text color="gray.400" fontSize={{ base: 'md', md: 'lg' }} maxW="720px" lineHeight="1.7">
            Download the latest applications, configuration utilities, and corresponding release notes
            for ArcisAI cameras and the Cloud VMS.
          </Text>
        </VStack>
        ...
        {!loading && !error && filteredData.length === 0 && (
          ...
          >
            ...
            {data.length === 0
              ? 'No tools available yet. Please check back later.'
