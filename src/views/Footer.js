    ...
    <Box w={"100%"} mt="-5%">
      ...
      >
        ...
        >
          ...
          >
            <Image loading="lazy"
              src="/images/playstore-button.webp" htmlWidth="480" htmlHeight="160"
          ...
          >
            <Image loading="lazy"
              src="/images/appstore-button.webp" htmlWidth="480" htmlHeight="160"
          ...
          >
            ...
            <Flex direction="column" gap={4}>
              <Flex direction="column" gap={2}>
                <Image loading="lazy" src="/images/ArcisAi_1.webp" htmlWidth="504" htmlHeight="105" alt="Logo" w="120px" />
