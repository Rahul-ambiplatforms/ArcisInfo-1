    ...
    <Box bgGradient={`linear(160deg, #1c1533, #171717)`} py={{ base: 12, md: 20 }}>
      <Container maxW="1100px">
        ...
        <Stack direction={{ base: 'column', sm: 'row' }} spacing={4}>
          <Button as="a" type={undefined} href={WA} onClick={() => trackCtaClick('whatsapp', 'become-a-distributor')} size="lg" bg={ACCENT} color="white" _hover={{ bg: ACCENT_DEEP }}>
            Apply on WhatsApp
          </Button>
          <Button as="a" type={undefined} href="mailto:marketing@arcisai.io?subject=ArcisAI%20Distributor%20Enquiry" onClick={() => trackCtaClick('email', 'become-a-distributor')} size="lg" variant="outline" borderColor={CARD_BORDER} color="white" _hover={{ bg: 'whiteAlpha.100' }}>
    ...
    <Container maxW="1100px" py={{ base: 12, md: 16 }}>
      ...
      <Box p={{ base: 6, md: 10 }} bgGradient={`linear(160deg, ${ACCENT_DEEP}, #2a2342)`} borderRadius="2xl" textAlign="center">
        ...
        <Stack direction={{ base: 'column', sm: 'row' }} spacing={4} justify="center">
          <Button as="a" type={undefined} href={WA} onClick={() => trackCtaClick('whatsapp', 'become-a-distributor')} size="lg" bg="white" color={ACCENT_DEEP} fontWeight="700" _hover={{ bg: 'gray.100' }}>Apply on WhatsApp</Button>
          <Button as="a" type={undefined} href="tel:+919687779999" onClick={() => trackCtaClick('phone', 'become-a-distributor')} size="lg" variant="outline" borderColor="whiteAlpha.500" color="white" _hover={{ bg: 'whiteAlpha.200' }}>Call +91 96877 79999</Button>
